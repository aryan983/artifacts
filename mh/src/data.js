...
var INSTRUCTION_INFO = {
  ...
  'EVICT':  { name:'EVICT  (L2 victim eviction)', color:'#ffa94d',
  ...
  'WR→DIR': { name:'WR→DIR  (write to Coherency Directory)', color:'#f06595',
    what:'A write operation notifying the Coherency Directory that a new owner is taking exclusive access. The directory looks up which SMs hold a copy of this address and issues targeted INVs only to them — avoiding a full broadcast.',
    why:'Directory-based invalidation scales with number of actual sharers, not total SM count. On Apex with 256+ SMs this avoids N×invalidation traffic.' },
